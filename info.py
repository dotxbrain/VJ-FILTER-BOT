...
auth_channel = environ.get('AUTH_CHANNEL', '-1002714564403') # give your force subscribe channel id here else leave it blank
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', 'dotxbrain_group')
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/dotxbrain_discussion')

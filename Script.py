...
🎬 ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ᴅᴏᴛxʙʀᴀɪɴ ᴍᴏᴠɪᴇ ʙᴏᴛ!
🔥 ʙʀɪɴɢɪɴɢ ʏᴏᴜ ʙᴏʟʟʏᴡᴏᴏᴅ, ʜᴏʟʟʏᴡᴏᴏᴅ & ᴏᴛᴛ ʙʟᴏᴄᴋʙᴜꜱᴛᴇʀꜱ
🎞️ ɴᴏ ʟɪɴᴋꜱ • ɴᴏ ᴀᴅꜱ • ᴊᴜꜱᴛ ᴘᴜʀᴇ ᴍᴏᴠɪᴇ ᴍᴀɢɪᴄ ✨
📥 ᴇɴᴛᴇʀ ᴛʜᴇ ᴍᴏᴠɪᴇ ɴᴀᴍᴇ ʏᴏᴜ ᴡᴀɴᴛ ᴛᴏ ᴡᴀᴛᴄʜ ᴏʀ ᴅᴏᴡɴʟᴏᴀᴅ 🎧
⚙️ ᴍᴀɴᴀɢᴇᴅ ʙʏ: @dotxbrain</b>"""
...
<b>ᴜʀʟ ʙᴜᴛᴛᴏɴꜱ:</b>
<code>[Button Text](buttonurl:https://t.me/dotxbrain_group)</code>
<b>ᴀʟᴇʀᴛ ʙᴜᴛᴛᴏɴꜱ:</b>
